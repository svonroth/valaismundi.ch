...
<?php 
	...
	//ADDED
	echo("<h3 class='font-166752 h3 text-color-jevc-color' style='margin-top:0;margin-bottom:10px;'><span>Filters</span></h3>");
...
?>
	...
	<!-- ADDED -->
	<h3 class="loc-title font-166752 h3 text-color-jevc-color" >Location</h3>
	<p class="loc-text" style="padding-bottom:0;color: #9a9a9a!important;font-style: italic;">Use the map to locate our point of sales by clicking on the red dot of your choice 
.</p>
	<p class="loc-back">< back</p>
	...
	<script type="text/javascript"> 
		...
		function drawMap(locs) {
			...
			backButton.on("click", function() {
				drawMap(currentSet);
				jQuery('.loc-title').text("Location");
				jQuery('.loc-text').text("Use the map to locate our point of sales by clicking on the red dot of your choice.");
			})
