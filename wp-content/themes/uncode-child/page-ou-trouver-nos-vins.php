...
<?php 
	...
	//ADDED
	echo("<h3 class='font-166752 h3 text-color-jevc-color' style='margin-top:0;margin-bottom:10px;'><span>Filtres</span></h3>");
...
?>
	<!-- ADDED -->
	<h3 class="loc-title font-166752 h3 text-color-jevc-color" >Localisation</h3>
	<p class="loc-text" style="padding-bottom:0;color: #9a9a9a!important;font-style: italic;">Utilisez la carte pour nous localiser en cliquant sur le point de votre choix.</p>
	<p class="loc-back">< retour à la liste</p>
	...
	<script type="text/javascript"> 
		...
		function drawMap(locs) {
			...
			backButton.on("click", function() {
				drawMap(currentSet);
				jQuery('.loc-title').text("Localisation");
				jQuery('.loc-text').text("Utilisez la carte pour nous localiser en cliquant sur le point de votre choix.");
			})
