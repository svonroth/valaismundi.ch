...
{
	$gravity_forms_array[esc_html__('No Gravity forms found.', 'uncode') ] = '';
	if (class_exists('RGFormsModel'))
	{
		...
		if ($gravity_forms)
		{
			$gravity_forms_array = array(
				esc_html__('Specify a form to display.', 'uncode') => ''
			);
	...
	vc_map(array(
		'name' => esc_html__('Gravity Form', 'uncode') ,
		'base' => 'gravityform',
		'icon' => 'icon-wpb-vc_gravityform',
		'category' => esc_html__('Content', 'uncode') ,
		'description' => esc_html__('Place Gravity form', 'uncode') ,
		'params' => array(
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Form', 'uncode') ,
				'param_name' => 'id',
				'value' => $gravity_forms_array,
				'description' => esc_html__('Specify a form to add it to your post or page.', 'uncode') ,
				'admin_label' => true
			) ,
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Display Form Title', 'uncode') ,
				'param_name' => 'title',
				'value' => array(
					esc_html__('No', 'uncode') => 'false',
					esc_html__('Yes', 'uncode') => 'true'
				) ,
				'description' => esc_html__('Would you like to display the forms title?', 'uncode') ,
				'dependency' => array(
					'element' => 'id',
					'not_empty' => true
				)
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Display Form Description', 'uncode') ,
				'param_name' => 'description',
				'value' => array(
					esc_html__('No', 'uncode') => 'false',
					esc_html__('Yes', 'uncode') => 'true'
				) ,
				'description' => esc_html__('Would you like to display the forms description?', 'uncode') ,
				'dependency' => array(
					'element' => 'id',
					'not_empty' => true
				)
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Enable AJAX?', 'uncode') ,
				'param_name' => 'ajax',
				'value' => array(
					esc_html__('No', 'uncode') => 'false',
					esc_html__('Yes', 'uncode') => 'true'
				) ,
				'description' => esc_html__('Enable AJAX submission?', 'uncode') ,
				'dependency' => array(
					'element' => 'id',
					'not_empty' => true
				)
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__('Tab Index', 'uncode') ,
				'param_name' => 'tabindex',
				'description' => esc_html__('(Optional) Specify the starting tab index for the fields of this form. Leave blank if you\'re not sure what this is.', 'uncode') ,
				'dependency' => array(
					'element' => 'id',
					'not_empty' => true
				)
